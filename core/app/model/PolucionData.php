<?php
class PolucionData {
	public static $tablename = "polucion";
	...
	public static function delById($id){
		$sql = "delete from ".self::$tablename." where id_polucion=$id";
		Executor::doit($sql);
	}
	public function del(){
		$sql = "delete from ".self::$tablename." where id_polucion=$this->id";
		Executor::doit($sql);
	}
...
// partiendo de que ya tenemos creado un objecto UserData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new PolucionData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new PolucionData());
	}
