...
class SistemaData {
	...
	public static function delById($id){
		$sql = "delete from ".self::$tablename." where id_so=$id";
		Executor::doit($sql);
	}
	public function del(){
		$sql = "delete from ".self::$tablename." where id_so=$this->id";
		Executor::doit($sql);
	}
...
// partiendo de que ya tenemos creado un objecto UserData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new SistemaData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new SistemaData());
	}
