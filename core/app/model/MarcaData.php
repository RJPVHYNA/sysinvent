<?php
class MarcaData {
	public static $tablename = "marcas";
	...
	public static function delById($id){
		$sql = "delete from ".self::$tablename." where id_marca=$id";
		Executor::doit($sql);
	}
	public function del(){
		$sql = "delete from ".self::$tablename." where id_marca=$this->id";
		Executor::doit($sql);
	}
...
// partiendo de que ya tenemos creado un objecto UserData previamente utilizamos el contexto
	...
	public function update_passwd(){
		$sql = "update ".self::$tablename." set password=\"$this->password\" where id_marca=$this->id";
		Executor::doit($sql);
	}
